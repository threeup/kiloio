...
{ 
    ...
    KActorCli.prototype.dispose = function()
    {
        this.actorData = null;
        this.inputData = null;
        this.torsobone.dispose();
        this.hipsbone.dispose();
        if( this.torso !== null )
        {
            this.torso.dispose();
            this.hips.dispose();
            ...
            this.rleg.dispose();
            this.hand.dispose();
            this.armlight.dispose();
        }
    }


    KActorCli.prototype.addModel = function(visual)
    {
        if( visual === "A")
        {
            this.addRobot();
    ...
    {
        this.torsobone = BABYLON.Mesh.CreateSphere("torsobone", g_unit, g_unit, game.scene);
        this.torsobone.position.y = g_unit * 1; 
        this.hipsbone = BABYLON.Mesh.CreateSphere("hipsbone", g_unit, g_unit, game.scene);
        this.hipsbone.position.y = g_unit * 1; 
    }

    KActorCli.prototype.addShoot = function()
    {
        this.torsobone = BABYLON.Mesh.CreateSphere("torsobone", g_unit*0.5, g_unit*0.5, game.scene);
        this.torsobone.position.y = g_unit * 1; 
        this.hipsbone = BABYLON.Mesh.CreateSphere("hipsbone", g_unit*0.3, g_unit*0.3, game.scene);
        this.hipsbone.position.x = g_unit * 1; 
        this.hipsbone.position.y = g_unit * 1; 
    }

    KActorCli.prototype.addRobot = function()
    {
