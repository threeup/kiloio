...
var KWorld = require('./KWorld');
var util = require('./util');

var KSectorSrv = (function () 
{ 
    function KSectorSrv(world,secX,secY,seed)
    {
        this.secX = secX;
        this.secY = secY;
        this.world = world;
        ...
        this.tree = quadtree.QUAD.init(treeargs);
    }
    ...
    KSectorSrv.prototype.setGround = function(tile, val)
    {
        var relTileX = (tile.x + this.sectorRadius) % this.sectorUnit;
        var relTileY = (tile.y + this.sectorRadius) % this.sectorUnit;
        var line = util.setCharAt(this.groundList[relTileY], relTileX, val);
