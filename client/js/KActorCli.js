...
{ 
    ...
    {
        var yawTorso = Math.atan2(-this.actorData.inputJoy.rfy, this.actorData.inputJoy.rfx);
        var yawHips = Math.atan2(-this.actorData.inputJoy.lfy, this.actorData.inputJoy.lfx);
        //console.log(this.actorData.inputJoy.rfy+','+this.actorData.inputJoy.rfx);
