...
{ 
  ...
  KGame.prototype.handleLogic = function() 
  {
    if( this.localUser !== null && this.localUser.mainActor !== null )
    {
      ...
      //this.localUser.mainActor.actorData.inputJoy.x = g_joy.x;
      var lsx = g_joy.right - g_joy.left;
      var lsy = g_joy.up - g_joy.down;
      var lslen = Math.sqrt(lsx*lsx + lsy*lsy);
      if ( lslen > 0.1 )
      {
        localActorData.inputJoy.lfx = lsx;
        localActorData.inputJoy.lfy = lsy;
      }
      localActorData.inputJoy.lsx = lsx;
      localActorData.inputJoy.lsy = lsy;
      ...
      if( rslensq > 0.1 )
      {
        localActorData.inputJoy.rfx = rsx;
        localActorData.inputJoy.rfy = rsy;
      }
      var rslen = Math.min(1, Math.sqrt(rslensq) );
      localActorData.inputJoy.rsx = rsx/rslen;
      localActorData.inputJoy.rsy = rsy/rslen;
      localActorData.inputJoy.p = g_joy.primary;
      localActorData.inputJoy.s = g_joy.secondary;
